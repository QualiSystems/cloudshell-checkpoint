...
from cloudshell.checkpoint.gaia.command_templates.error_map import BASIC_ERRORS, PASSWORD_ERROR_MAP
from cloudshell.cli.command_template.command_template import CommandTemplate

SNMP_ERROR_MAP = OrderedDict(
    [("does not accept community strings", "SNMP v3-Only does not accept community strings."), ])
...
SNMP_PASSWORD_ERROR_MAP = OrderedDict(chain(BASIC_ERRORS.items(), PASSWORD_ERROR_MAP.items()))
...
SET_V3_SNMP_USER_PRIV = CommandTemplate(
    ...
    "privacy-protocol {priv_encrypt_protocol}", error_map=SNMP_PASSWORD_ERROR_MAP)
